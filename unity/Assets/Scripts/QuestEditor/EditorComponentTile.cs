...
namespace Assets.Scripts.QuestEditor
{
    public class EditorComponentTile : EditorComponent
    {
        ...
        override public float AddSubComponents(float offset)
        {
            ...
            game.tokenBoard.AddHighlight(TILE_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.location, "TileAnchor",
                Game.EDITOR);
        ...
        public void ChangeTileSide()
        {
            ...
            Game game = Game.Get();
            UIWindowSelectionListTraits select = new UIWindowSelectionListImage(SelectTileSide,
        ...
        public void TileRotate()
        {
            ...
            else if (TILE_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.rotation > 0 &&
                     TILE_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.rotation <= 100)
            {
                TILE_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.rotation = 180;
            }
            else if (TILE_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.rotation > 100 &&
                     TILE_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.rotation <= 190)
            {
