    ...
    public class EditorComponentEvent : EditorComponent
    {
        ...
        override public float AddSubComponents(float offset)
        {
            ...
            for (index = 0; index < EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.addComponents.Length; index++)
            {
                ...
                if (game.quest.qd.components.ContainsKey(
                    EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.addComponents[i]))
                {
                    ...
                    {
                        QuestEditorData.SelectComponent(EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT
                            .addComponents[i]);
                    });
            ...
            for (index = 0; index < EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.removeComponents.Length; index++)
            {
                ...
                if (game.quest.qd.components.ContainsKey(EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT
                    .removeComponents[i]))
                {
                    ui.SetLocation(0.5f, offset, 17, 1);
                    UIElement link = new UIElement(Game.EDITOR, scrollArea.GetScrollTransform());
        ...
        virtual public float AddHeroSelection(float offset)
        {
            ...
            if (game.quest.qd.components.ContainsKey(EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.heroListName))
            {
                ...
                {
                    QuestEditorData.SelectComponent(EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.heroListName);
                });
        ...
        virtual public float AddNextEventComponents(float offset)
        {
            ...
            foreach (List<string> l in EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.nextEvent)
            {
                ...
                string colorRGB =
                    ColorUtil.FromName(EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.buttonColors[buttonTmp - 1]);
        ...
        {
            if (EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.locationSpecified ||
                EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.maxCam ||
                EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.minCam)
            {
                CameraController.SetCamera(EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.location);
                game.tokenBoard.AddHighlight(EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.location, "EventLoc",
                    Game.EDITOR);
            }
        }
        ...
        public void UpdateText()
        {
            if (eventTextUIE.Changed())
            {
                ...
                {
                    LocalizationRead.updateScenarioText(EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.text_key,
                        eventTextUIE.GetText());
                    if (EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.buttons.Count == 0)
                    {
                        EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.buttons.Add(
                            EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.genQuery("button1"));
                        ...
                        LocalizationRead.updateScenarioText(
                            EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.genKey("button1"),
                            CONTINUE.Translate());
                    }
        ...
        public void SetTrigger()
        {
            ...
            UIWindowSelectionListTraits select = new UIWindowSelectionListTraits(SelectEventTrigger,
        ...
        public void SetAudio()
        {
            ...
            UIWindowSelectionListTraits select = new UIWindowSelectionListAudio(SelectEventAudio,
                new StringKey("val", "SELECT", new StringKey("val", "AUDIO")));
        ...
        public void SelectEventAudio(string audio)
        {
            ...
            {
                string path = Path.GetDirectoryName(Game.Get().quest.qd.questPath) + Path.DirectorySeparatorChar +
                              EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.audio;
        ...
        public void AddMusic(int index)
        {
            ...
            UIWindowSelectionListTraits select = new UIWindowSelectionListAudio(
                delegate(string s) { SelectMusic(index, s); },
                new StringKey("val", "SELECT", new StringKey("val", "AUDIO")));
        ...
        public void SetHighlight()
        {
            ...
            UIWindowSelectionListTraits select = new UIWindowSelectionListTraits(SelectEventHighlight,
        ...
        public void SetHeroCount(bool max)
        {
            ...
            UIWindowSelectionList select = new UIWindowSelectionList(
                delegate(string s) { SelectEventHeroCount(max, s); },
        ...
        public void AddVisibility(bool add, int index = -1)
        {
            ...
            UIWindowSelectionListTraits select = new UIWindowSelectionListTraits(
                delegate(string s) { SelectAddVisibility(add, index, s); },
                new StringKey("val", "SELECT", new StringKey("val", "COMPONENT")));
            ...
            foreach (KeyValuePair<string, QuestComponent> kv in game.quest.qd.components)
            {
                if (kv.Value is DoorQuestComponent || kv.Value is TileQuestComponent ||
                    kv.Value is TokenQuestComponent || kv.Value is UiQuestComponent)
                {
                    select.AddItem(kv.Value);
                }
        ...
        public void SelectAddVisibility(bool add, int index, string component)
        {
            ...
            if (component.Equals("{NEW:Door}"))
            {
                ...
                doorQuestComponent.location.x = game.gameType.TileRound() *
                                                Mathf.Round(cc.gameObject.transform.position.x /
                                                            game.gameType.TileRound());
                doorQuestComponent.location.y = game.gameType.TileRound() *
                                                Mathf.Round(cc.gameObject.transform.position.y /
                                                            game.gameType.TileRound());
            ...
            if (component.Equals("{NEW:Tile}"))
            {
                ...
                CameraController cc = GameObject.FindObjectOfType<CameraController>();
                tileQuestComponent.location.x = game.gameType.TileRound() *
                                                Mathf.Round(cc.gameObject.transform.position.x /
                                                            game.gameType.TileRound());
                tileQuestComponent.location.y = game.gameType.TileRound() *
                                                Mathf.Round(cc.gameObject.transform.position.y /
                                                            game.gameType.TileRound());
            ...
            if (component.Equals("{NEW:Token}"))
            {
                ...
                CameraController cc = GameObject.FindObjectOfType<CameraController>();
                tokenQuestComponent.location.x = game.gameType.TileRound() *
                                                 Mathf.Round(cc.gameObject.transform.position.x /
                                                             game.gameType.TileRound());
                tokenQuestComponent.location.y = game.gameType.TileRound() *
                                                 Mathf.Round(cc.gameObject.transform.position.y /
                                                             game.gameType.TileRound());
        ...
        {
            EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.randomEvents =
                !EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.randomEvents;
            Update();
        }
        ...
        public void SetQuotaVar()
        {
            ...
            UIWindowSelectionListTraits select =
                new UIWindowSelectionListTraits(SelectQuotaVar, new StringKey("val", "SELECT", VAR));
        ...
        public void AddButton()
        {
            ...
            EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.nextEvent.Add(new List<string>());
            EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.buttons.Add(
                EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.genQuery("button" + count));
            EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.buttonColors.Add("white");
            LocalizationRead.updateScenarioText(
                EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.genKey("button" + count), BUTTON.Translate() + count);
            Update();
        }
        ...
        public void RemoveButton()
        {
            ...
            LocalizationRead.dicts["qst"]
                .Remove(EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.genKey("button" + count));
            Update();
        }
        ...
        public void SetButtonColor(int number)
        {
            ...
            UIWindowSelectionList select =
                new UIWindowSelectionList(delegate(string s) { SelectButtonColour(number, s); },
        ...
        public void UpdateButtonLabel(int number)
        {
            ...
            {
                LocalizationRead.updateScenarioText(
                    EVENT_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.genKey("button" + number),
                    buttonUIE[number - 1].GetText());
            }
        }
