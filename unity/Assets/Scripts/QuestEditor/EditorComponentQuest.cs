...
namespace Assets.Scripts.QuestEditor
{
    public class EditorComponentQuest : EditorComponent
    {
        ...
        override public float AddSubComponents(float offset)
        {
            ...
            ui = new UIElement(Game.EDITOR, scrollArea.GetScrollTransform());
            ui.SetLocation(0, offset, 7.5f, 1);
            ui.SetText(new StringKey("val", "X_COLON",
                new StringKey("val", "MIN_X", new StringKey("val", "DURATION"))));
            ...
            ui.SetLocation(9.5f, offset, 7.5f, 1);
            ui.SetText(new StringKey("val", "X_COLON",
                new StringKey("val", "MAX_X", new StringKey("val", "DURATION"))));
        ...
        public void Image()
        {
            ...
            string relativePath = new FileInfo(Path.GetDirectoryName(Game.Get().quest.qd.questPath.Replace('\\', '/')))
                .FullName.Replace('\\', '/');
        ...
        public void UpdateQuestDesc()
        {
            if (descriptionUIE.Changed())
            {
                ...
                {
                    LocalizationRead.updateScenarioText(game.quest.qd.QuestIniComponent.description_key,
                        descriptionUIE.GetText());
                }
        ...
        public void UpdateQuestSynopsys()
        {
            if (synopsysUIE.Changed())
            {
                ...
                {
                    LocalizationRead.updateScenarioText(game.quest.qd.QuestIniComponent.synopsys_key,
                        synopsysUIE.GetText());
                }
        ...
        public void UpdateQuestAuth()
        {
            if (authorsUIE.Changed())
            {
                ...
                {
                    LocalizationRead.updateScenarioText(game.quest.qd.QuestIniComponent.authors_key,
                        authorsUIE.GetText());
                }
        ...
        public void UpdateQuestShortAuth()
        {
            if (authors_shortUIE.Changed())
            {
                ...
                {
                    LocalizationRead.updateScenarioText(game.quest.qd.QuestIniComponent.authors_short_key,
                        authors_shortUIE.GetText());
                }
