    ...
    public class QuestEditorData
    {
        ...
        public static void TypeSelect(string type = "")
        {
            ...
            UIWindowSelectionListTraits select =
                new UIWindowSelectionListTraits(SelectComponent, CommonStringKeys.SELECT_ITEM);
        ...
        public void NewTile()
        {
            ...
            tileQuestComponent.location.x = game.gameType.TileRound() *
                                            Mathf.Round(cc.gameObject.transform.position.x / game.gameType.TileRound());
            tileQuestComponent.location.y = game.gameType.TileRound() *
                                            Mathf.Round(cc.gameObject.transform.position.y / game.gameType.TileRound());
        ...
        public void NewDoor()
        {
            ...
            CameraController cc = GameObject.FindObjectOfType<CameraController>();
            doorQuestComponent.location.x = game.gameType.SelectionRound() *
                                            Mathf.Round(cc.gameObject.transform.position.x /
                                                        game.gameType.SelectionRound());
            doorQuestComponent.location.y = game.gameType.SelectionRound() *
        ...
        public void NewToken()
        {
            ...
            CameraController cc = GameObject.FindObjectOfType<CameraController>();
            tokenQuestComponent.location.x = game.gameType.SelectionRound() *
                                             Mathf.Round(cc.gameObject.transform.position.x /
                                                         game.gameType.SelectionRound());
            tokenQuestComponent.location.y = game.gameType.SelectionRound() *
                                             Mathf.Round(cc.gameObject.transform.position.y /
                                                         game.gameType.SelectionRound());
        ...
        public void NewCustomMonster()
        {
            ...
            game.quest.qd.components.Add("CustomMonster" + index,
                new CustomMonsterQuestComponent("CustomMonster" + index));
