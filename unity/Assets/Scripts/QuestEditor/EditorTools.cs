    ...
    public class EditorTools
    {
        ...
        private static void CreatePackage()
        {
            ...
            try
            {
                ...
                foreach (KeyValuePair<string, string> kv in LocalizationRead.selectDictionary("qst")
                    .ExtractAllMatches("Quest.name"))
                {
                    manifest += "name." + kv.Key + "=" + kv.Value + System.Environment.NewLine;
                }

                foreach (KeyValuePair<string, string> kv in LocalizationRead.selectDictionary("qst")
                    .ExtractAllMatches("Quest.synopsys"))
                {
                ...
                foreach (KeyValuePair<string, string> kv in LocalizationRead.selectDictionary("qst")
                    .ExtractAllMatches("Quest.description"))
                {
                ...
                foreach (KeyValuePair<string, string> kv in LocalizationRead.selectDictionary("qst")
                    .ExtractAllMatches("Quest.authors"))
                {
                ...
                foreach (KeyValuePair<string, string> kv in LocalizationRead.selectDictionary("qst")
                    .ExtractAllMatches("Quest.authors_short"))
                {
