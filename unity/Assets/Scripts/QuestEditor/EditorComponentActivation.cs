...
namespace Assets.Scripts.QuestEditor
{
    public class EditorComponentActivation : EditorComponent
    {
        ...
        {
            Game game = Game.Get();
            ACTIVATION_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT =
                game.quest.qd.components[nameIn] as ActivationQuestComponent;
        ...
        public float D2EActivation(float offset)
        {
            ...
            masterActionsUIE.SetText(ACTIVATION_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.masterActions
                .Translate(true));
            ...
            minionActionsUIE.SetText(ACTIVATION_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.minionActions
                .Translate(true));
        ...
        public void UpdateAbility()
        {
            if (!abilityUIE.Empty() && abilityUIE.Changed())
            {
                ...
                LocalizationRead.updateScenarioText(ACTIVATION_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.ability_key,
                    abilityUIE.GetText());
        ...
        public void UpdateMoveButton()
        {
            if (moveButtonUIE.Empty())
            {
                LocalizationRead.dicts["qst"]
                    .Remove(ACTIVATION_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.movebutton_key);
            }
            else if (moveButtonUIE.Changed())
            {
                //insert the text in the current language
                LocalizationRead.updateScenarioText(ACTIVATION_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.movebutton_key,
                    moveButtonUIE.GetText());
            }
        }
        ...
        public void UpdateMasterActions()
        {
            ...
            {
                LocalizationRead.updateScenarioText(ACTIVATION_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.master_key,
                    masterActionsUIE.GetText());
            }
        ...
        public void UpdateMinionActions()
        {
            ...
            {
                LocalizationRead.updateScenarioText(ACTIVATION_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.minion_key,
                    minionActionsUIE.GetText());
            }
        ...
        public void UpdateMove()
        {
            ...
            {
                LocalizationRead.updateScenarioText(ACTIVATION_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.move_key,
                    moveUIE.GetText());
            }
        ...
        {
            ACTIVATION_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.masterFirst =
                !ACTIVATION_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.masterFirst;
            Update();
        }
        ...
        {
            ACTIVATION_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.minionFirst =
                !ACTIVATION_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.minionFirst;
            Update();
        }
    }
