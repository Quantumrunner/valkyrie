...
namespace Assets.Scripts.QuestEditor
{
    public class QuestEditSelection
    {
        ...
        {
            Game game = Game.Get();
            string dataLocation = Game.AppData() + Path.DirectorySeparatorChar + Game.Get().gameType.TypeName() +
                                  "/Editor";
        ...
        public void NewQuest()
        {
            ...
            try
            {
                ...
                DictionaryI18n newScenarioDict =
                    new DictionaryI18n(new string[1] {".," + game.currentLang}, game.currentLang);
