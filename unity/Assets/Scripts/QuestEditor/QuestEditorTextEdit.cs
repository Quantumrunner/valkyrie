...
namespace Assets.Scripts.QuestEditor
{
    ...
    public class QuestEditorTextEdit
    {
        ...
        public void EditText(UnityEngine.Events.UnityAction call)
        {
            ...
            transBg.SetInsetAndSizeFromParentEdge(RectTransform.Edge.Top, 3 * UIScaler.GetPixelsPerUnit(),
                UIScaler.GetPixelsPerUnit());
            transBg.SetInsetAndSizeFromParentEdge(RectTransform.Edge.Left,
                UIScaler.GetHCenter(-9) * UIScaler.GetPixelsPerUnit(), 18 * UIScaler.GetPixelsPerUnit());
