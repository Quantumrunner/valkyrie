    ...
    public class EditorComponentSpawn : EditorComponentEvent
    {
        ...
        override public float AddSubEventComponents(float offset)
        {
            ...
            for (i = 0; i < SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.mTypes.Length; i++)
            {
                ...
                if ((SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.mTypes.Length > 1) ||
                    (SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.mTraitsRequired.Length > 0) ||
                    (SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.mTraitsPool.Length > 0))
                {
                    ui = new UIElement(Game.EDITOR, scrollArea.GetScrollTransform());
                ...
                if (game.quest.qd.components.ContainsKey(SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.mTypes[i]))
                {
                    ...
                    link.SetButton(delegate
                    {
                        QuestEditorData.SelectComponent(
                            SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.mTypes[mSlot]);
                    });
            ...
            for (i = 0; i < SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.mTraitsRequired.Length; i++)
            {
                ...
                if ((SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.mTypes.Length > 0) ||
                    (SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.mTraitsRequired.Length > 1) ||
                    (SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.mTraitsPool.Length > 0))
                {
                    ui = new UIElement(Game.EDITOR, scrollArea.GetScrollTransform());
                    ui.SetLocation(0.5f, offset, 1, 1);
            ...
            for (int j = 0; j < SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.mTraitsPool.Length; j++)
            {
                ...
                if ((SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.mTypes.Length > 0) ||
                    (SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.mTraitsRequired.Length > 0) ||
                    (SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.mTraitsPool.Length > 1))
                {
                    ui = new UIElement(Game.EDITOR, scrollArea.GetScrollTransform());
        ...
        {
            SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.locationSpecified =
                !SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.locationSpecified;
            Update();
        }
        ...
        {
            SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.unique =
                !SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.unique;
            if (!SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.unique)
            {
            ...
            {
                LocalizationRead.updateScenarioText(SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.uniquetitle_key,
                    SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.sectionName);
        ...
        public void UpdateHealthHero()
        {
            float.TryParse(healthHeroUIE.GetText(),
                out SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.uniqueHealthHero);
            Update();
        }
        ...
        public void MonsterTypeAdd(int pos)
        {
            ...
            UIWindowSelectionListTraits select = new UIWindowSelectionListTraits(
                delegate(string s) { SelectMonsterType(s, pos); },
        ...
        public void MonsterTypeReplace(int pos)
        {
            ...
            Game game = Game.Get();
            UIWindowSelectionListTraits select = new UIWindowSelectionListTraits(
                delegate(string s) { SelectMonsterType(s, pos, true); },
                new StringKey("val", "SELECT", CommonStringKeys.MONSTER));
        ...
        public void MonsterTraitReplace(int pos, bool pool = false)
        {
            ...
            UIWindowSelectionList select = new UIWindowSelectionList(
                delegate(string s) { SelectMonsterTraitReplace(pos, pool, s); },
        ...
        public void MonsterTraitsAdd(bool pool = false)
        {
            ...
            UIWindowSelectionList select = new UIWindowSelectionList(
                delegate(string s) { SelectMonsterTrait(pool, s); },
                new StringKey("val", "SELECT", CommonStringKeys.TRAITS));
            foreach (string s in traits)
            {
                select.AddItem(new StringKey("val", s));
        ...
        {
            if ((SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.mTypes.Length +
                 SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.mTraitsPool.Length +
                 SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.mTraitsRequired.Length) <= 1)
            {
                return;
            }
        ...
        public void MonsterPlaceAdd(int heroes, int slot = -1)
        {
            ...
            Game game = Game.Get();
            UIWindowSelectionListTraits select = new UIWindowSelectionListTraits(
                delegate(string s) { MonsterPlaceAddSelection(heroes, slot, s); }, CommonStringKeys.SELECT_ITEM);
        ...
        public void MonsterPlaceAddSelection(int heroes, int slot, string name)
        {
            ...
            {
                string[] newM =
                    new string[SPAWN_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.placement[heroes].Length + 1];
                int i;
