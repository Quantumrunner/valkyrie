...
namespace Assets.Scripts.QuestEditor
{
    public class EditorComponentPuzzle : EditorComponentEvent
    {
        ...
        override public float AddSubEventComponents(float offset)
        {
            ...
            if (PUZZLE_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.puzzleClass.Equals("image") ||
                PUZZLE_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.puzzleClass.Equals("code"))
            {
                ui = new UIElement(Game.EDITOR, scrollArea.GetScrollTransform());
        ...
        public void UpdatePuzzleSolution()
        {
            ...
            foreach (string part in solutionArray)
            {
                ...
                {
                    ValkyrieDebug.Log("Puzzle solution " + j + " out of AltLevel " +
                                      PUZZLE_QUEST_COMPONENT_QUEST_COMPONENT_COMPONENT.puzzleAltLevel + " range.");
                    invalid = true;
                }
            }
