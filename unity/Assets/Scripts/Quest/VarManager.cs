    ...
    public class VarManager
    {
        ...
        public void SetValue(string var, float value)
        {
            if (!vars.ContainsKey(var))
            {
                ...
                {
                    Game.Get().quest.log.Add(new LogEntry("Notice: Adding Quest var: " + var, true));
                }
        ...
        public float GetOpValue(VarOperation op)
        {
            ...
            {
                Game.Get().quest.log.Add(new LogEntry("Notice: Adding Quest var: " + op.var, true));
                vars.Add(op.var, 0);
            }
        ...
        public void Perform(VarOperation op)
        {
            ...
            if (op.operation.Equals("+"))
            {
                ...
                Game.Get().quest.log
                    .Add(new LogEntry(
                        "Notice: Adding: " + value + " to Quest var: " + op.var + " result: " + vars[op.var], true));
            }
            ...
            if (op.operation.Equals("-"))
            {
                ...
                Game.Get().quest.log
                    .Add(new LogEntry(
                        "Notice: Subtracting: " + value + " from Quest var: " + op.var + " result: " + vars[op.var],
                        true));
            }
            ...
            if (op.operation.Equals("*"))
            {
                ...
                Game.Get().quest.log
                    .Add(new LogEntry(
                        "Notice: Multiplying: " + value + " with Quest var: " + op.var + " result: " + vars[op.var],
                        true));
            }
            ...
            if (op.operation.Equals("/"))
            {
                ...
                Game.Get().quest.log
                    .Add(new LogEntry(
                        "Notice: Dividing Quest var: " + op.var + " by: " + value + " result: " + vars[op.var], true));
            }
            ...
            if (op.operation.Equals("%"))
            {
                ...
                Game.Get().quest.log
                    .Add(new LogEntry(
                        "Notice: Modulus Quest var: " + op.var + " by: " + value + " result: " + vars[op.var], true));
            }

            if (op.operation.Equals("="))
            {
                vars[op.var] = value;
                Game.Get().quest.log.Add(new LogEntry("Notice: Setting: " + op.var + " to: " + value, true));
            }
        }
        ...
        public bool Test(VarTests tests)
        {
            ...
            foreach (VarTestsComponent tc in tests.VarTestsComponents)
            {
                ...
                else if (tc is VarTestsParenthesis)
                {
                    ...
                    if (tp.parenthesis == "(")
                    {
                        List<VarTestsComponent> remaining_tests =
                            tests.VarTestsComponents.GetRange(index + 1, tests.VarTestsComponents.Count - (index + 1));
                        if (current_operator == "AND")
