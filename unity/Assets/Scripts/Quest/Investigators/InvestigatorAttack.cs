...
namespace Assets.Scripts.Quest.Investigators
{
    ...
    public class InvestigatorAttack
    {
        ...
        public InvestigatorAttack(Monster m)
        {
            monster = m;
            AttackOptions();
        }
        ...
        public void Attack(string type)
        {
            ...
            attackText =
                EventManager.OutputSymbolReplace(text.Translate().Replace("{0}", monster.monsterData.name.Translate()));
            Game.Get().quest.log.Add(new LogEntry(attackText.Replace("\n", "\\n")));
            Attack();
        }
