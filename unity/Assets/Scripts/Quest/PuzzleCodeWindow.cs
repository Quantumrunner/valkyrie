...
namespace Assets.Scripts.Quest
{
    public class PuzzleCodeWindow
    {
        ...
        public PuzzleCodeWindow(ValkyrieEvent e)
        {
            ValkyrieEventData = e;
            Game game = Game.Get();
            ...
            else
            {
                ...
                puzzle = new PuzzleCode(QUEST_PUZZLE_QUEST_COMPONENT_QUEST_COMPONENT.puzzleLevel,
                    QUEST_PUZZLE_QUEST_COMPONENT_QUEST_COMPONENT.puzzleAltLevel,
                    QUEST_PUZZLE_QUEST_COMPONENT_QUEST_COMPONENT.puzzleSolution);
            }
        ...
        public List<ButtonInfo> GetButtons()
        {
            ...
            for (int i = 0; i <= QUEST_PUZZLE_QUEST_COMPONENT_QUEST_COMPONENT.puzzleAltLevel; i++)
            {
                if (QUEST_PUZZLE_QUEST_COMPONENT_QUEST_COMPONENT.imageType.Equals("symbol"))
                {
                    ...
                    if (dupeTex != null)
                    {
                        buttons.Add(new ButtonInfo(Sprite.Create(dupeTex, new Rect(0, 0, dupeTex.width, dupeTex.height),
