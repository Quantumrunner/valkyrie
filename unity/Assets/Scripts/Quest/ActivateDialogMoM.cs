...
namespace Assets.Scripts.Quest
{
    ...
    public class ActivateDialogMoM : ActivateDialog
    {
        ...
        public ActivateDialogMoM(Monster m) : base(m, true)
        {
        }
        ...
        override public void CreateWindow(bool singleStep = false)
        {
            ...
            if (monster.currentActivation.effect.Length > 0)
            {
                ...
                // Add this to the log
                Game.Get().quest.log.Add(new LogEntry(textKey.Replace("\n", "\\n")));
                ui = new UIElement();
        ...
        public void CreateAttackWindow()
        {
            ...
            // Add this to the log
            Game.Get().quest.log.Add(new LogEntry(monster.currentActivation.masterActions.Replace("\n", "\\n")));
        ...
        public void CreateMoveWindow()
        {
            ...
            // Add this to the log
            Game.Get().quest.log.Add(new LogEntry(monster.currentActivation.move.Replace("\n", "\\n")));
