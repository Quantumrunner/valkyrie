...
namespace Assets.Scripts.Quest
{
    ...
    public class RoundController
    {
        ...
        public void ParticalActivationComplete(Monster m)
        {
        ...
        // Activate a monster
        virtual public bool ActivateMonster(Monster m)
        {
                ...
                if (!qm.useMonsterTypeActivations)
                {
                    ...
                    foreach (string s in qm.activations)
                    {
                        ...
                        if (game.quest.qd.components.ContainsKey("Activation" + s)
                            && game.quest.vars.Test(
                                (game.quest.qd.components["Activation" + s] as ActivationQuestComponent).tests)
                        )
                        {
                            adList.Add(new QuestActivation(
                                game.quest.qd.components["Activation" + s] as ActivationQuestComponent));
                        }
        ...
        public virtual bool CheckNewRound()
        {
            ...
            game.quest.log.Add(new LogEntry(new StringKey("val", "ROUND", round).Translate()));
